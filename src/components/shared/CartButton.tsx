...
const CartButton = forwardRef<HTMLButtonElement, React.ButtonHTMLAttributes<HTMLButtonElement>>(
  (props, ref) => {
    ...
    return (
      <Button ref={ref} {...props} className="group flex items-center gap-2 text-white relative">
